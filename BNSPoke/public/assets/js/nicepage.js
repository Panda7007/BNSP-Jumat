        ...
        o((function() {
            ...
            o(document).on("click", "[data-href]:not(.u-back-to-top), [data-post-link]", (function(t) {
                if (!t.isDefaultPrevented()) {
                    var e = o(this), url = e.attr("data-href") || e.attr("data-post-link"), n = e.attr("data-target") || "", i = window.location.href.split("/"), a, s = i[i.length - 1].split("#")[0], u = o(e).parents("body").find("header") && o(e).parents("body").find("header").hasClass("u-sticky") || o(e).is(".u-icon"), l = url && (url.startsWith("#") || url.startsWith("/#") || url.startsWith("./#") || url.includes("#") && !!s && url.includes(s));
...
* Copyright (c) 2019 Dmitry Semenov; */
    ...
    13881: function(t, e, n) {
        ...
        n(13882);
        var i = n(31), Utils;
        n(4117).animationsEnabled() && i(window).on("load", (function() {
            var t;
...
*/
    ...
    13894: function(t, e, n) {
        "use strict";
        var i = n(13895), Utils;
        n(4117).animationsEnabled() && document.addEventListener("np.responsive.init", function(t) {
            setTimeout((function() {
                var e;
 ...
 */
    ...
    13905: function(t, e, n) {
        "use strict";
        var i = n(31), GalleryLayout = n(13906), Filter;
    ...
    13938: function(t, e, n) {
        "use strict";
        var i = n(13939), o = n(13940), a = n(13946), s, u;
        new o(i).subscribe(),
        new a(i).subscribe()
    },
